...
class UserAuthorityAdminListResponse implements IBaseResponse
{
    ...
    public function fill(): array
    {
        ...
        foreach ($this->userAuthorityAggregate->getUserAuthorityList() as $userAuthority) {
            array_push($response, [
                ...
                "updated_at" => $userAuthority->updated_at->toDateTimeString(),
                "deleted_at" => $userAuthority->deleted_at ? $userAuthority->deleted_at->toDateTimeString() : null,
